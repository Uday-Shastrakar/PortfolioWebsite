...
const Header = () => {
  ...
  return (
    ...
    {/* Mobile Brand Name (Floating, No Bar) */}
    <div className="md:hidden fixed top-0 left-0 right-0 z-[55] px-6 py-5 flex justify-between items-center pointer-events-none">
      <h1 className="text-xl font-bold bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent pointer-events-auto drop-shadow-sm">
        {brandName}
      </h1>
    </div>
