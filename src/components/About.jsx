...
const About = () => {
  const [data] = useState({
    ...
    desc2: `I enjoy understanding how systems work internally, including dependency injection, database transaction flows, and performance optimization. Recently I have been building a real-time options analytics platform.`,
    actionButton: {
      title: "Read More..",
      link: "/about",
    },
